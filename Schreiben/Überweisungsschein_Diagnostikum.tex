...
%---------------------------------------------------------------------------
\begin{letter}{Diagnostikum Berlin\\Mahlsdorfer Straße 107\\12555 Berlin}
%---------------------------------------------------------------------------
% Weitere Optionen
\KOMAoptions{%%
}
%---------------------------------------------------------------------------
%\setkomavar{subject}{Nachreichen des Überweisungsscheines}
%---------------------------------------------------------------------------
\opening{Sehr geehrte Damen und Herren,}

anbei übersende ich Ihnen die fehlende Überweisung meines Orthopäden. Ich möchte Sie bitten, den Befund an meinen Hausorthopäden in Aschaffenburg, Herrn Dr. Helmut Klotz zu weiterzuleiten (Faxnummer: 0602124434).
...
%---------------------------------------------------------------------------
%\ps{PS:}
\encl{Überweisungsschein für MRT mit Kontrastmittelgabe}
%\cc{}
%---------------------------------------------------------------------------
\end{letter}
%---------------------------------------------------------------------------
