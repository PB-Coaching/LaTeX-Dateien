...
bitte Ã¼bersenden Sie mir eine Ãbersicht der getÃ¤tigten Zahlungen in der betreffenden\\
GeschÃ¤ftssache sowie des noch verbleibenden Betrags.

\closing{Vielen Dank im Vorraus,}
%---------------------------------------------------------------------------
%\ps{PS:}
%\encl{UnterlassungserklÃ¤rung \& Kopie des Hartz IV-Bescheids}
%\cc{}
%---------------------------------------------------------------------------
\end{letter}
%---------------------------------------------------------------------------
