...
\setkomavar{Versicherungsnummer} {48 706 551 A 00016}%%      Unser Zeichen
...
für Zahnersatz sind mir Kosten entstanden. Hiermit nehme ich meine Versicherungsleistungen Ihnen gegenüber in Anspruch. Die entsprechenden Unterlagen finden Sie als Kopie diesem Schreiben beigefügt.


Meine Kontoverbindung:\\

\textsf{\textbf{IBAN:} DE 77 1009 0000 7043 0037 50\\
\textbf{BIC:} BEVODEBB\\
Berliner Volksbank\\}
...
%---------------------------------------------------------------------------
%\ps{PS:}
\encl{Kopie des Heilkostenplanes \& Kopie der Rechnungsaufstellung}
%\cc{}
%---------------------------------------------------------------------------
\end{letter}
%---------------------------------------------------------------------------
