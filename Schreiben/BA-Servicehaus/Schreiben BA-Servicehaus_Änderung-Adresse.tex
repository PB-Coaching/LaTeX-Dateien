...
\setkomavar{Akte} {6201033685983}%    'Aktenzeichen...'
...
%---------------------------------------------------------------------------
\begin{letter}{BA-Servicehaus\\G\"{o}rresstra\ss{}e 15\\45657 Recklinghausen \\Niemcy}
%---------------------------------------------------------------------------
% Weitere Optionen
\KOMAoptions{%
}
%---------------------------------------------------------------------------
\setkomavar{subject}{\textbf{Adress\"{a}nderung}}
%---------------------------------------------------------------------------
\opening{Sehr geehrte Damen und Herren,}

meine Postanschrift hat sich ge\"{a}ndert.

Sie erreichen mich postalisch nunmehr unter:\\

\textbf{Dobrego Pasterza 27B/2\\
31-416 Krakau, Polen}
