...
\setkomavar{fromaddress}{Rozdroże 17c/23\\30-333 Krakau, Polen}
...
%---------------------------------------------------------------------------
\begin{letter}{BA-Servicehaus\\Görresstraße 15\\45657 Recklinghausen \\Niemcy}
%---------------------------------------------------------------------------
% Weitere Optionen
\KOMAoptions{%
}
%---------------------------------------------------------------------------
\setkomavar{subject}{Adressänderung}
%---------------------------------------------------------------------------
\opening{Sehr geehrte Damen und Herren,}

meine Postanschrift hat sich geändert.
