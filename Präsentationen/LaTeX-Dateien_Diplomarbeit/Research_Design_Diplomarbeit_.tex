...
\begin{document}
	...
	\end{center} 	
		...
		\begin{itemize}
			...
			\item{\textcolor{midblue}{\sffamily{\textbf{\emph{Kann die EU-Energiepolitik den baltischen Länder aus ihrer Abhängigkeit von russischen Gaslieferungen helfen?}}}}}
 
 			\begin{itemize}
 			
 				\item{Anwendung von IB-Theorien \& Integrationsans\"{a}tzen 
 							auf den europïäischen Integrationsprozess}
