...
\newkomavar*[Geschäftszeichen]{GESCHÄFT}
...
%\setkomavar{GESCHÄFT}{BG 92210/0026652}
...
%---------------------------------------------------------------------------
\begin{letter}{Bezirksamt Tempelhof-Schöneberg\\Abteilung Jugend, Ordnung, Bürgerdienste - Wohnungswesen\\Tempelhofer Damm 165\\12099 Berlin}
%---------------------------------------------------------------------------
% Weitere Optionen
\KOMAoptions{%
}
%---------------------------------------------------------------------------
\setkomavar{subject}{\textbf{Aktueller Bescheid des Jobcenters \& Kontoauszug}}
%---------------------------------------------------------------------------
\opening{Sehr geehrte Frau Fest,}

wie gewünscht übersende ich Ihnen hiermit den aktualisierten Leistungsbescheid des Jobcenters sowie meinen Kontoauszug für den Monat Oktober als Zahlungsbeleg. 
...
%---------------------------------------------------------------------------
%\ps{PS:}
\encl{Leistungsbescheid Jobcenter Tempelhof-Schöneberg \& Kontoauszug für Monat Oktober}
%\cc{}
%---------------------------------------------------------------------------
\end{letter}
%---------------------------------------------------------------------------
